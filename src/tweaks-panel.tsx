...
export function TweaksPanel({ title = 'Tweaks', noDeckControls = false, children }: TweaksPanelProps): React.ReactElement | null {
...
export function TweakSection({ label, children }: TweakSectionProps): React.ReactElement {
  return (
    <>
...
export function TweakRow({ label, value, children, inline = false }: TweakRowProps): React.ReactElement {
  return (
...
export function TweakSlider({ label, value, min = 0, max = 100, step = 1, unit = '', onChange }: TweakSliderProps): React.ReactElement {
  return (
...
export function TweakToggle({ label, value, onChange }: TweakToggleProps): React.ReactElement {
  return (
...
type SegOption = string | number | boolean | { value: string | number | boolean; label: string };
...
export function TweakRadio({ label, value, options, onChange }: TweakRadioProps): React.ReactElement {
  ...
  const segAt = (clientX: number): string | number | boolean => {
...
export function TweakSelect({ label, value, options, onChange }: TweakSelectProps): React.ReactElement {
  return (
    <TweakRow label={label}>
...
export function TweakText({ label, value, placeholder, onChange }: TweakTextProps): React.ReactElement {
  return (
    <TweakRow label={label}>
...
export function TweakNumber({ label, value, min, max, step = 1, unit = '', onChange }: TweakNumberProps): React.ReactElement {
  ...
  const onScrubStart = (e: React.PointerEvent) => {
    ...
    const move = (ev: PointerEvent) => {
      ...
      onChange(clampVal(Number(snapped.toFixed(decimals))));
    };
    const up = () => {
      window.removeEventListener('pointermove', move);
      window.removeEventListener('pointerup', up);
...
export function TweakColor({ label, value, options, onChange }: TweakColorProps): React.ReactElement {
...
export function TweakButton({ label, onClick, secondary = false }: TweakButtonProps): React.ReactElement {
  return (
